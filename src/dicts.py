...
# Address edge cases in abstract metadata entries.
# For 2015 poster data, titles of entries with IDs 3108T, 3034T, and 3070T cannot be detected as the fonts are not bold, and the
# body of entry with ID 1885W is crowded and cannot tell breaks between authors and body content sections.
# For 2015 platform data, the body of entry with ID 168 is crowded and cannot tell breaks between authors and body content sections.
# For 2022 poster data, the body of entry with ID 1537 is not read completely.
...
# For 2019 poster data, the keys are abstract topics and the corresponding values are abstract/poster board numbers range.
...
# Topic reassignment credit to Professor Hila Milo Rasouly.
